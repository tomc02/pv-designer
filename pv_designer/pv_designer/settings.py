"""
Django settings for pv_designer project.
...
SECRET_KEY = 'django-insecure-h^u)-(cch7#2zao@x5d+4t4p(46yndu@#zs72@v*dr&l!n_i7@'
...
INSTALLED_APPS = [
    ...
    'web_pv_designer.apps.WebPvDesignerConfig',
...
ROOT_URLCONF = 'pv_designer.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'web_pv_designer', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'pv_designer.wsgi.application'

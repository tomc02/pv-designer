# Generated by Django 4.2.5 on 2024-03-10 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mounting_position', models.CharField(choices=[('free', 'Free standing'), ('building', 'Roof added'), ('optimize', 'Optimize position')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pv_technology', models.CharField(choices=[('crystSi', 'Crystalline silicon'), ('CIS', 'Copper indium selenide'), ('CdTe', 'Cadmium telluride'), ('Unknown', 'Unknown')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('areas', models.ManyToManyField(blank=True, to='web_pv_designer.area')),
                ('pv_power_plant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='web_pv_designer.pvsystemdetails')),
                ('solar_panel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='web_pv_designer.solarpanel')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('power_plant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='monthly_consumptions', to='web_pv_designer.pvsystemdetails')),
            ],
            options={
